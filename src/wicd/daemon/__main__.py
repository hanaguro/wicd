...
class WicdDaemon(dbus.service.Object):
    ...
    """
    def __init__(self, bus, args, object_path="/org/wicd/daemon"):
        ...
        self.wired_bus = WiredDaemon(bus, self, wired=self.wired)
        self.wireless_bus = WirelessDaemon(bus, self, wifi=self.wifi)
